...
public class CIES1 extends JFrame {
		...
		public CIES1() {
			...
			MATHS1 = new JCheckBox("APPLIED MATHEMATICS IV :");
			...
			PHY1 = new JCheckBox("BUILDING DESIGN & DRAWING :");
			PHY1.setBounds(27, 110, 182, 23);
			frame.getContentPane();
			frame.add(PHY1);
			
			PL = new JLabel("Building Design-H. K. Malik (Rs399)");
			PL.setBounds(37, 140, 288, 14);
			frame.getContentPane();
			frame.add(PL);
			
			
			CHEM1 = new JCheckBox("BUILDING MATERIALS & CONSTRUCTION TECHNOLOGY :");
			CHEM1.setBounds(27, 179, 450, 23);
			frame.getContentPane();
			frame.add(CHEM1);
			
			CL = new JLabel("Building Material-Jain & Jain (Rs430)");
			CL.setBounds(37, 209, 346, 14);
			frame.getContentPane();
			frame.add(CL);
			
			
			MECH = new JCheckBox("FLUID MACHANICS-II :");
			MECH.setBounds(27, 247, 388, 23);
			frame.getContentPane();
			frame.add(MECH);
			
			MCL = new JLabel("Fluid Mechanics by A K Tayal (Rs320)");
			MCL.setBounds(37, 277, 450, 14);
			frame.getContentPane();
			frame.add(MCL);
			
			
			BEE = new JCheckBox("STRUCTURAL ANALYSIS-I :");
			BEE.setBounds(27, 317, 475, 23);
			frame.getContentPane();
			frame.add(BEE);
			
			BL = new JLabel("B.L.Theraja - Structural Engineering (Rs290)");
			BL.setBounds(37, 347, 465, 14);
			frame.getContentPane();
			frame.add(BL);
			
			EVS = new JCheckBox("SURVEYING-II :");
			...
			Button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					frame.dispose();
					CIESP1 frame = new CIESP1(M1,P1,C1,MC,B,E);
					frame.setVisible(true);
