...
public class CIESP1 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CIESP1(int i,int j,int k,int l,int m,int n){    
	...
	if(j==1) {
		...
		data[x][0] = "BUILDING DESIGN & DRAWING"; 
		data[x][1] = "Rs399";
		p2=399;
		x++;
	}
	...
	if(k==1) {
		...
		data[x][0] = "BUILDING MATERIALS & CONSTRUCTION TECHNOLOGY "; 
		data[x][1] = "Rs430";
		p3=430;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "STRUCTURAL ANALYSIS-I "; 
		data[x][1] = "Rs320";
		p4=320;
		x++;
	}
