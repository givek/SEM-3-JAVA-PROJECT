...
public class CIESP2 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CIESP2(int i,int j,int k,int l,int m,int n){    
	...
	if(k==1) {
		...
		data[x][0] = "GEOTECHNICAL ENGINEERING–I"; 
		data[x][1] = "Rs430";
		p3=430;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "STRUCTURAL ANALYSIS–II"; 
		data[x][1] = "Rs320";
		p4=320;
		x++;
	}
	...
	if(m==1) {
		...
		data[x][0] = "TRANSPORTATION ENGINEERING–I"; 
		data[x][1] = "Rs290";
		p5=290;
		x++;
	}
