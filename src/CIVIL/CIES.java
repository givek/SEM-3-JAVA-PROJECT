...
public class CIES extends JFrame {
		...
		public CIES() {
			...
			DLDA = new JCheckBox("SURVEYING-I :");
			...
			DISCRETE = new JCheckBox("STRENGTH OF MATERIALS :");
			...
			ECCF = new JCheckBox("ENGINEERING GEOLOGY :");
			...
			DATA = new JCheckBox("FLUID MECHANICS-I :");
			...
			Button.addActionListener(new ActionListener() {			
				...
				frame.dispose();
				CIESP frame = new CIESP(M3,DL,DM,E,DS);
				frame.setVisible(true);
