...
public class CIES2 extends JFrame {
		...
		public CIES2() {
			...
			MATHS1 = new JCheckBox("APPLIED HYDRAULICS :");
			MATHS1.setBounds(27, 45, 189, 23);
			frame.getContentPane();
			frame.add(MATHS1);
			
			ML = new JLabel("A text book of Applied Hydraulics, P.N.Wartikar (Rs350)");
			ML.setBounds(37, 75, 350, 14);
			frame.getContentPane();
			frame.add(ML);
			
			
			PHY1 = new JCheckBox("ENVIRONMENTAL ENGINEERING–I :");
			PHY1.setBounds(27, 110, 250, 23);
			frame.getContentPane();
			frame.add(PHY1);
			
			PL = new JLabel("Environmental Engineering-H. K. Malik (Rs399)");
			PL.setBounds(37, 140, 288, 14);
			frame.getContentPane();
			frame.add(PL);
			
			
			CHEM1 = new JCheckBox("GEOTECHNICAL ENGINEERING–I  :");
			...
			MECH = new JCheckBox("STRUCTURAL ANALYSIS–II :");
			...
			BEE = new JCheckBox("TRANSPORTATION ENGINEERING–I :");
			...
			Button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					frame.dispose();
					CIESP2 frame = new CIESP2(M1,P1,C1,MC,B,E);
					frame.setVisible(true);
