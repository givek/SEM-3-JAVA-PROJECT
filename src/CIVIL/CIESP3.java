...
public class CIESP3 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CIESP3(int i,int j,int k,int l,int m,int n){    
	...
	if(i==1) {
		...
		data[x][0] = "GEOTECHNICAL ENGINEERING–II"; 
		data[x][1] = "Rs350";
		p1=350;
		x++;
		}
	...
	if(j==1) {
		...
		data[x][0] = "DESIGN AND DRAWING OF STEEL STRUCTURES "; 
		data[x][1] = "Rs399";
		p2=399;
		x++;
	}
