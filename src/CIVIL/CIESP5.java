...
public class CIESP5 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CIESP5(int i,int j,int k,int l){    
	...
	if(i==1) {
		...
		data[x][0] = "DESIGN AND DRAWING OF REINFORCED CONCRETE STRUCTURES "; 
		data[x][1] = "Rs350";
		p1=350;
		x++;
		}
	...
	if(j==1) {
		...
		data[x][0] = "CONSTRUCTION MANAGEMENT "; 
		data[x][1] = "Rs399";
		p2=399;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "BRIDGE DESIGN ENGINEERING "; 
		data[x][1] = "Rs320";
		p4=320;
		x++;
	}
