...
public class CESP2 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CESP2(int i,int j,int k,int l,int m){    
	...
	if(j==1) {
		...
		data[x][0] = "DATABASE MANAGEMENT SYSTEM"; 
		data[x][1] = "Rs310";
		p2=310;
		x++;
	}
	...
	if(k==1) {
		...
		data[x][0] = "THEORY OF COMPUTER SCIENCE"; 
		data[x][1] = "Rs430";
		p3=430;
		x++;
	}
