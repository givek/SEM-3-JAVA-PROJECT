...
public class CESP extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CESP(int i,int j,int k,int l,int m){    
	...
	if(j==1) {
		...
		data[x][0] = "DIGITAL LOGIC DESIGN & ANALYSIS"; 
		data[x][1] = "Rs320";
		p2=320;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "ELECTRONIC CIRCUIT AND COMMUNICATION FUNDAMENTALS"; 
		data[x][1] = "Rs400";
		p4=400;
		x++;
	}
