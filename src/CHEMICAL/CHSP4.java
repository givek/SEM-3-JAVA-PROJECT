...
public class CHSP4 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CHSP4(int i,int j,int k,int l){    
	...
	if(i==1) {
		...
		data[x][0] = "Process Equipment Design "; 
		data[x][1] = "Rs350";
		p1=350;
		x++;
		}
	...
	if(l==1) {
		...
		data[x][0] = "Corrosion Engineering :"; 
		data[x][1] = "Rs446";
		p3=446;
		x++;
	}
	if(k==1) {
		...
		data[x][0] = "Process Dynamics and Control "; 
		data[x][1] = "Rs350";
		p3=350;
		x++;
	}
