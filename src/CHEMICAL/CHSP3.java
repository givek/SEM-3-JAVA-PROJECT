...
public class CHSP3 extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CHSP3(int i,int j,int k,int l,int m){    
	...
	if(i==1) {
		...
		data[x][0] = "Environmental Engineering "; 
		data[x][1] = "Rs350";
		p1=350;
		x++;
		}
	...
	if(j==1) {
		...
		data[x][0] = "Mass Transfer Operation II "; 
		data[x][1] = "Rs399";
		p2=399;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "Chemical Reaction Engineering II"; 
		data[x][1] = "Rs446";
		p4=446;
		x++;
	}
	...
	if(m==1) {
		...
		data[x][0] = "Plant Engineering and Industrial Safety :"; 
		data[x][1] = "Rs328";
		p5=328;
		x++;
	}
