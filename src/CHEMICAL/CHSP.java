...
public class CHSP extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    CHSP(int i,int j,int k,int l,int m,int n){    
	...
	if(j==1) {
		...
		data[x][0] = "ENGINEERING CHEMISTRY I:"; 
		data[x][1] = "Rs399";
		p2=399;
		x++;
	}
	...
	if(k==1) {
		...
		data[x][0] = "FLUID FLOW OPERATIONS"; 
		data[x][1] = "Rs430";
		p3=430;
		x++;
	}
	...
	if(l==1) {
		...
		data[x][0] = "CHEMICAL ENGINEERING THERMODYNAMICS I:"; 
		data[x][1] = "Rs446";
		p4=446;
		x++;
	}
