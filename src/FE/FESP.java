...
public class FESP extends JFrame {    
    
	private JPanel contentPane;
	private JTable table;
	private JButton BPrint;
    
    FESP(int i,int j,int k,int l,int m,int n){    
	...
	if(i==1) {
		...
		data[x][0] = "APPLIED MATHEMATICS I"; 
		data[x][1] = "Rs350";
		p1=350;
		x++;
		}
	...
	if(l==1) {
		...
		data[x][0] = "ENGINEERING MECHANICS"; 
		data[x][1] = "Rs320";
		p4=320;
		x++;
	}
	...
	if(m==1) {
		...
		data[x][0] = "BASIC ELECTRICAL ENGINEERING"; 
		data[x][1] = "Rs290";
		p5=290;
		x++;
	}
	...
	if(n==1) {
		...
		data[x][0] = "ENVIRONMENTAL STUDIES"; 
		data[x][1] = "Rs210";
		p6=210;
		x++;
	}
